    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (int_inputWatt < 120)
            {
                ...
                Console.WriteLine("Non-Summer months:" + Math.Round(int_inputWatt * nosummer[0], 2));
            }
            else if( int_inputWatt<=330)
            {
                Console.WriteLine("Summer months:" + Math.Round(int_inputWatt * summer[1], 2));
                Console.WriteLine("Non-Summer months:" + Math.Round(int_inputWatt * nosummer[1], 2));
            }
            else if (int_inputWatt <= 500)
            {
                Console.WriteLine("Summer months:" + Math.Round(int_inputWatt * summer[2], 2));
                Console.WriteLine("Non-Summer months:" + Math.Round(int_inputWatt * nosummer[2], 2));
            }
            else if (int_inputWatt <= 700)
            {
                Console.WriteLine("Summer months:" + Math.Round(int_inputWatt * summer[3], 2));
                Console.WriteLine("Non-Summer months:" + Math.Round(int_inputWatt * nosummer[3], 2));
            }
            else
            {
                Console.WriteLine("Summer months:" + Math.Round(int_inputWatt * summer[4], 2));
                Console.WriteLine("Non-Summer months:" + Math.Round(int_inputWatt * nosummer[4], 2));
            }
            Console.ReadLine();
        }
    }
